        ...
        const fetchDocs = async () => {
            try {
                ...
                if (firebaseError.code === 'permission-denied') {
                    // Silent fail or UI indication depending on design.
                    // For documents, empty list might be confusing if actual error.
                    // Let's log it more visibly or set an error state if we had one.
                    console.warn("Documents permission denied.");
                }
            } finally {
                setLoading(false);
            }
